...
ENT.Model = "models/weapons/myt_ins1/c_gren_rgd5.mdl"
ENT.FuseTime = 2
ENT.ArmTime = 0
...
function ENT:Initialize()
    if SERVER then
		...
		self:SetPos( self.Owner:GetShootPos() + self:GetForward() * 32 )
...
function ENT:Detonate()
    if SERVER then
        ...
        util.BlastDamage(self, attacker, self:GetPos(), 450, 200)
