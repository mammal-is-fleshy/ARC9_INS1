...
SWEP.WorldModelMirror = "models/weapons/myt_ins1/c_rif_tavor.mdl"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = "tavor_ready", -- QC sequence source, can be {"table", "of", "strings"} or "string"
        --Time = 0.5, -- overrides the duration of the sequence
        Mult = 1, -- multiplies time
        EventTable = {
            {s =  "myt_ins1/tavor_boltpull.wav" ,    t = 7 / 30},
			{s =  "myt_ins1/tavor_boltrel.wav" ,    t = 10 / 30}, 
        },
        IKTimeLine = {
        { t = 0, lhik = 1, rhik = 1, },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            {s =  "myt_ins1/tavor_clipout.wav" ,   t = 22 / 30},
            {s =  "myt_ins1/tavor_clipin.wav" ,    t = 53 / 30},
            {s =  "myt_ins1/tavor_boltpull.wav" ,    t = 75 / 30},
			{s =  "myt_ins1/tavor_boltrel.wav" ,    t = 80 / 30}, 
            },
        IKTimeLine = {
        { t = 0, lhik = 1, rhik = 1, },
        { t = 0.2, lhik = 0, rhik = 1, },{ t = 0.75, lhik = 0, rhik = 1, },{ t = 0.95, lhik = 1, rhik = 1, },
