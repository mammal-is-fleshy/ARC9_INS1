...
SWEP.WorldModelMirror = "models/weapons/myt_ins1/c_sr_xm21.mdl"
...
SWEP.RecoilUp = 1.05 -- Multiplier for vertical recoil
...
SWEP.Attachments = {
	...
	{
        PrintName = "RHIK",
        DefaultName = "you werent supposed to read this",
		Hidden = true,
        Installed = "myt_ins1_rhik_xm21",
        Integral = true,
		Slot = {"myt_ins1_rhik_xm21"},
		
        Category = {"ins1_bodge_xm21"},
        Bone = "Weapon_Controller",
        Pos = Vector(-7.5, -1.75, -1.5),
        Ang = Angle(0, 0, -90),
    },
}
...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        EjectAt = 15 / 30,
        EventTable = {
			{s =  "myt_ins1/m14-boltback.wav" ,    t = 10 / 30},
			{s =  "myt_ins1/m14-boltforward.wav" ,    t = 16 / 30},
        },
        FireASAP = true,
        MinProgress = 0.7,
        IKTimeLine = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			...
			{s =  "myt_ins1/m14-hit.wav" ,    t = 35 / 30},
        },
        IKTimeLine = {
        { t = 0, lhik = 1, rhik = 1, },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            {s =  "myt_ins1/m14-magout.wav" ,   t = 10 / 30},  
			{s =  "myt_ins1/m14-hit.wav" ,    t = 35 / 30},
			{s =  "myt_ins1/m14-boltback.wav" ,    t = 62 / 30},
			{s =  "myt_ins1/m14-boltforward.wav" ,    t = 68 / 30},
            },
        IKTimeLine = {
        { t = 0, lhik = 1, rhik = 1, },
        { t = 0.1, lhik = 0, rhik = 0, },{ t = 0.5, lhik = 0, rhik = 1, },{ t = 0.75, lhik = 1, rhik = 0, },{ t = 0.95, lhik = 1, rhik = 1, },
        },
    },
}